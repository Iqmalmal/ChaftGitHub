        ...
        <div class="tab-content">
          <div id="signup">   
            ...
            <div class="field-wrap mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="name" autocomplete="off" />
            ...
            <div class="field-wrap mb-6">
                ...
                <input type="email" class="border border-gray-200 rounded p-2 w-full" name="email" autocomplete="off" />
            ...
            <div class="field-wrap mb-6">
                ...
                <input type="password" class="border border-gray-200 rounded p-2 w-full" name="password" autocomplete="off" />
            ...
            <div class="field-wrap mb-6">
                ...
                <input type="password" class="border border-gray-200 rounded p-2 w-full" name="password_confirmation" autocomplete="off" />
